...
const CHIP = (active: boolean) =>
  "text-[11.5px] px-2.5 py-1 rounded-md border " +
  (active
        ...
        <div className="max-w-4xl mx-auto px-7 py-6">
          ...
          <div className="flex gap-5 border-b border-border mb-4">
            ...
            >
              Pending
              {items.length > 0 && (
                <span className="text-[11px] px-1.5 rounded-md bg-accentSoft text-accent leading-4">
                  {items.length}
                </span>
              )}
            </button>
            ...
            >
              Configure
              {unroutedCount > 0 && (
                <span className="text-[11px] px-1.5 rounded-md bg-warnSoft text-warnInk leading-4">
                  ⚠ {unroutedCount}
                </span>
              )}
            </button>
