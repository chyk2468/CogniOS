...
// reads as a screenshot of Slack), CogniOS on the right (app tokens). Tabs
...
const CAPTIONS = [
  "Mention @CogniOS in any channel it's invited to — a session opens here, and the answer lands back in Slack as a thread.",
    ...
    <div className="mb-5" data-testid="slack-howitworks">
      <div className="flex items-baseline gap-2.5">
        <h3 className="text-[13.5px] font-semibold tracking-tight">
          Getting started with Slack &amp; CogniOS
        </h3>
        <button
          className="ml-auto shrink-0 inline-flex items-center gap-1.5 text-[12px] text-muted hover:text-fg"
...
function SlackRail({ active }: { active: string }) {
  return (
    <div className="hiw-slrail">
      ...
      <div className="hiw-slnav"><span className="hiw-appav">OW</span>CogniOS</div>
    </div>
  );
}
  ...
  return (
    <div className="hiw-win hiw-ow">
      <div className="hiw-owtop">
        <span className="hiw-dots"><i /><i /><i /></span> CogniOS
      </div>
...
function OwRail({ hot, hotSub, glow }: { hot?: string; hotSub?: string; glow?: boolean }) {
  return (
    <div className="hiw-owrail">
      <div className="hiw-brand">CogniOS</div>
      ...
      <div className="hiw-sess"><b>Jira vs Linear</b>CogniWork</div>
    </div>
  );
}
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@CogniOS</span> summarize this thread
            </Msg>
          </div>
          ...
          <div className="hiw-slthread hiw-k" style={d("5.1s")}>
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="OW" avBg="#4a154b" name="CogniOS" app ts="6:34 PM">
      ...
      <OwWin>
        ...
        <div className="hiw-owmain">
          ...
          <div className="hiw-owchat">
            <div className="hiw-bub user hiw-k" style={d("2.8s")}>@CogniOS summarize this thread</div>
          ...
          <div className="hiw-owcomposer">Message CogniOS…</div>
        </div>
      </OwWin>
    </>
  );
          ...
          <div className="hiw-slthread">
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="P" avBg="#7c6cd0" name="Priya N" ts="6:36 PM" delay=".8s">
                <span className="hiw-men">@CogniOS</span> break it down by country?
              </Msg>
              <Msg av="OW" avBg="#4a154b" name="CogniOS" app ts="6:36 PM" delay="4.8s">
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@CogniOS</span> pull the signup numbers?
            </Msg>
          </div>
          <SlackComposer placeholder="Message #launch-room" />
        </div>
