    ...
    <div>
      <div className="flex items-center justify-end mb-4">
        <input
          ...
          className="w-44 px-3.5 py-1.5 rounded-md border border-border bg-panel text-[13px] outline-none focus:border-accent"
        />
      </div>
      ...
      {!showAll && !q && available.length > AVAILABLE_FOLD && (
        <div className={FOOT}>
          ...
          <button className="text-muted hover:text-fg" onClick={() => setShowAll(true)}>
            show all
          </button>
        </div>
      )}
