...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with CogniOS hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with CogniOS"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask CogniOS to revise")).toBeNull();
