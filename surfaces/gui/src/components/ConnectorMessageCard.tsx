...
export function ConnectorMessageCard({
  ...
  return (
    <article
      className="connector-card rounded-md2 border border-border bg-panel overflow-hidden"
      data-brand={key}
      style={styleVars}
    >
      <header
        className="connector-card-head flex items-center gap-2 px-3.5 py-2 border-b border-border outline-none"
        tabIndex={0}
        onMouseEnter={reveal}
        onMouseLeave={hide}
        onFocus={reveal}
