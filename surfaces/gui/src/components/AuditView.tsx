...
const INPUT = "px-3 py-1.5 rounded-md border border-border bg-bg text-[13px] text-fg outline-none focus:border-accent";
const BTN_ACCENT = "text-[12.5px] px-3 py-1.5 rounded-md bg-accent text-white shrink-0";
  ...
  return (
    <div className={CARD + " p-3.5"}>
      <div className="flex items-center gap-2 flex-wrap">
        <span className="font-mono text-[12.5px] font-medium text-fg">{ev.tool}</span>
