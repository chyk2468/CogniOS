              ...
              <div>
                ...
                {adding ? (
                  <div className="mt-1.5">
                    <input
                      className="w-full px-2.5 py-1.5 rounded-md border border-border bg-panel text-[12.5px] outline-none focus:border-accent"
                    ...
                    <div className="mt-1 max-h-64 overflow-y-auto">
                      {results.map((c) => (
                        <button
                          key={c.name}
                          className="w-full flex items-center gap-2 py-1.5 px-0.5 rounded-md text-left hover:bg-bg"
...
function ConnectInline({
  ...
  return (
    <div>
      <button
        className="inline-flex items-center gap-1 text-[12px] text-faint hover:text-fg mb-2"
        onClick={onBack}
      ...
      <p className="text-[10.5px] text-faint mt-2 leading-snug">
        Connecting makes {c.title} available to all your CogniWork agents — the toggle in this list
