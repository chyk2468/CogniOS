...
export function UpdateBanner() {
  ...
  return (
    ...
    <div
      className="fixed bottom-[64px] left-3 z-[35] w-[240px] rounded-md border border-border bg-panel shadow-2xl px-4 py-3.5"
      role="status"
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-2.5">
        <button
          className="px-3 py-1.5 rounded-md bg-accent text-white text-[12.5px] disabled:opacity-50"
          onClick={install}
          disabled={busy}
