// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real CogniOS mark
...
test("boot splash shows the CogniOS star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting CogniOS|Restoring your session/)).toBeVisible();
});
