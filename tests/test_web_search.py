...
from cogniwork.web import (
    SearchResult,
    build_provider,
    make_web_search_tool,
    provider_names,
)
from cogniwork.web.providers import (
    BraveProvider,
    DuckDuckGoProvider,
    TavilyProvider,
    WebSearchProvider,
...
def test_tool_returns_results():
    ...
    assert tool.__cogniwork_schema__["function"]["name"] == "web_search"
...
def test_resolve_provider_from_secretstore(tmp_path):
    from cogniwork.web import resolve_provider
...
def test_engine_registers_web_search(tmp_path):
    ...
    from cogniwork.agents import chat_agent
