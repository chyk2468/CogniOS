...
from cogniwork.providers.vertex_provider import VertexProvider, load_credentials
...
def test_api_key_method_builds_express_gemini_client(monkeypatch):
    ...
    from cogniwork.providers import GeminiProvider
...
def _patch_verify(monkeypatch, creds: Any, status_code: int | None):
    ...
    import cogniwork.providers.vertex_provider as vp
