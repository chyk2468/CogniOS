"""cmd_add (scripts/cognios-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "cognios-memory"
    loader = importlib.machinery.SourceFileLoader("cognios_memory_cli_add", str(path))
