...
from cogniwork.providers import AnthropicProvider, capabilities_for
from cogniwork.providers.anthropic_provider import (
    DEFAULT_MAX_TOKENS,
    convert_messages,
    convert_tools,
)
...
def test_resolve_api_key_env_then_secrets(monkeypatch):
    from cogniwork.providers.anthropic_provider import resolve_api_key
...
def test_thinking_defaults_on_with_hidden_profile_override():
    ...
    from cogniwork.providers.anthropic_provider import DEFAULT_THINKING_BUDGET
    from cogniwork.providers.registry import build_provider_client
