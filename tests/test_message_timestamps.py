...
def test_provider_adapters_drop_ts():
    ...
    reaches the wire."""
    from cogniwork.providers.anthropic_provider import convert_messages as to_anthropic
    from cogniwork.providers.gemini_provider import convert_messages as to_gemini
