...
from cogniwork.memory.settings import MAX_USER_RULES_CHARS, format_user_rules
...
def test_knowledge_is_fixed_for_the_session_and_fresh_for_new_ones(tmp_path):
    """§7.1 (owner decision 2026-07-28): what a cogniwork KNOWS is fixed when the
