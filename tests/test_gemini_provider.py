...
from cogniwork.providers import GeminiProvider, capabilities_for
from cogniwork.providers.gemini_provider import (
    _sanitize_schema,
    convert_messages,
    convert_tools,
)
...
def test_resolve_api_key_env_then_secrets(monkeypatch):
    from cogniwork.providers.gemini_provider import resolve_api_key
...
def test_convert_pdf_file_part_to_inline_data():
    from cogniwork.providers.gemini_provider import _user_parts
