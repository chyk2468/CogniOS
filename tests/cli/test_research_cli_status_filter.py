"""`cognios-research list --status complete` was returning nothing.
...
Part of #2122 (cognios-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "cognios-research"
    loader = importlib.machinery.SourceFileLoader("cognios_research_cli", str(path))
