...
```text
[order-report] working directory: /path/to/cognios
...
[order-report] reproduce with: /path/to/cognios/venv/bin/python /path/to/cognios/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
