...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'cognios-model-expanded',
  MODEL_ENDPOINTS: 'cognios-model-endpoints',
  MODEL_SELECTED: 'cognios-selected-model',
  SORT_ORDER: 'cognios-sessions-sort',
  CHAT_SEARCH_SCOPE: 'cognios-search-scope',
  INCOGNITO: 'cognios-incognito',
  RAG_ACTIVE: 'cognios-rag-active',
  MCP_ACTIVE: 'cognios-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'cognios-density',
  UI_SCALE: 'cognios-ui-scale',
  WORKSPACE: 'cognios-workspace'
};
