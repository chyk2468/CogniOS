...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'cognios-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'cognios-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('cognios:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
