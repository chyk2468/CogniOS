...
const LS_KEY = 'cognios-theme';
const CUSTOM_THEMES_KEY = 'cognios-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'CogniOS Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'cognios-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'cognios_' + (obj.name || 'theme') + '.json';
      a.click();
