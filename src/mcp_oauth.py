...
Registration, authorization-code + PKCE, token refresh) to CogniOS's web
...
# on CogniOS. APP_PORT is intentionally not used: it is only the Docker host
