...
COPILOT_USER_AGENT = os.environ.get(
    "COGNIOS_COPILOT_USER_AGENT", "CogniOS/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "COGNIOS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "COGNIOS_COPILOT_EDITOR_VERSION", "CogniOS/1.0"
)
