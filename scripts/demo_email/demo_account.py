#!/usr/bin/env python3
"""Create/remove the switchable, non-default 'Demo' EmailAccount in CogniOS.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@cognios.local mailbox. Password is stored Fernet-encrypted
