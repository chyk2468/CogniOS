"""scripts/_lib/cli.py — shared scaffolding for the `cognios-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("cognios-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/cognios-foo`
...
VERSION = "0.1.0"  # bumped centrally; every cognios-* CLI reports this
