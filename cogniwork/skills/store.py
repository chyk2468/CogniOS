...
project skills in ``<workspace>/.cogniwork/skills``. There is no database; every operation
...
class SkillStore:
    ...
    def project_dir(self, workspace: str | Path) -> Path:
        return Path(workspace).expanduser().resolve() / ".cogniwork" / "skills"
...
def save_skill_tool(
    ...
    *,
    ...
    save_skill.__cogniwork_schema__ = _SAVE_SKILL_SCHEMA
    return save_skill
