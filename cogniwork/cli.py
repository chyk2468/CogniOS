"""CLI entry point. `cogniwork` launches the TUI; `cogniwork code` boots the code skill."""
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="cognios", description="Agent cogniwork (TUI)."
    )
    parser.add_argument(
    ...
    memory_store = SQLiteMemoryStore(data_dir / "cogniwork.db")
    ...
    from .tui.app import CogniWorkApp
