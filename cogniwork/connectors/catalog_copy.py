...
the CogniOS Cloud app requests. Overclaiming here is a product bug.
...
ABOUT: dict[str, str] = {
    "telegram": "Chat with your cogniwork from Telegram. Messages to your bot "
    "reach the agent and replies come back to the same chat — only senders on "
    "your allow-list get through.",
    "slack": "Bring your cogniwork into Slack: mention it in a channel or DM it, "
    ...
    "status. One click installs the CogniOS GitHub App on the repositories "
