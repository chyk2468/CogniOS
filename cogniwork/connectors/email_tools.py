...
def resolve_servers(profile: dict[str, Any]) -> tuple[EmailServers | None, str]:
...
def _select_readonly(imap: imaplib.IMAP4, folder: str) -> str | None:
...
) -> email_lib.message.Message | None:
...
def _attach(
    ...
    *,
    ...
    fn.__name__ = name
    fn.__cogniwork_schema__ = schema
