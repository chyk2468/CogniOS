...
python -m cogniwork.connectors.cli status
    Show which platforms are configured (token present) + allowlist size.

python -m cogniwork.connectors.cli fake [--user U1] [--allow U1]
...
python -m cogniwork.connectors.cli send --target telegram:12345 --text "hi"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="cogniwork-connectors")
