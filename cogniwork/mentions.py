...
When @CogniOS is tagged in a channel with no subscribed session, the router spawns a
cogniwork session that OWNS that thread and replies into it. This store is the
