...
class LocalExecutor(Executor):
    def __init__(
        ...
        *,
        ...
        self._marker = f"__COGNIWORK_DONE_{uuid.uuid4().hex}__"
...
def shell_tools(executor: Executor) -> list:
    ...
    wrapped_run.__cogniwork_schema__ = _RUN_SHELL_SCHEMA
    ...
    wrapped_output.__cogniwork_schema__ = _TASK_OUTPUT_SCHEMA
    ...
    wrapped_kill.__cogniwork_schema__ = _TASK_KILL_SCHEMA
