...
Shares CogniWork's workspace toolset but has its own personality + prompt: a personal assistant
...
from .cogniwork import cogniwork_tool_factory
...
def myhelper_instructions(name: str = DEFAULT_HELPER_NAME) -> str:
    return (
        ...
        "big, self-contained jobs you may later hand off to a dedicated CogniWork session. Treat "
