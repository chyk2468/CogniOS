...
Imports MemoryManager and MemoryVectorStore from the CogniOS codebase.
"""
...
_OWNER_ENV_KEYS = ("COGNIOS_MCP_MEMORY_OWNER", "COGNIOS_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set COGNIOS_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
