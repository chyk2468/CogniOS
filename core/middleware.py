...
INTERNAL_TOOL_TOKEN = os.environ.get("COGNIOS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-CogniOS-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-CogniOS-Internal-Token), or
